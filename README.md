...
- 4: Start a new terminal inside Docker Desktop (or use CMD or PowerShell), and execute "cd (The directory you have cloned this project into)".
- 5: Execute "docker-compose up --build", wait until the terminal says "Uvicorn running on...".
